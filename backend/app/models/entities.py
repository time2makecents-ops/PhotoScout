...
class Profile(Base):
    ...
    avatar_position_x: Mapped[int] = mapped_column(Integer, default=50)
    avatar_position_y: Mapped[int] = mapped_column(Integer, default=50)
    avatar_scale: Mapped[float] = mapped_column(Float, default=1.0)
